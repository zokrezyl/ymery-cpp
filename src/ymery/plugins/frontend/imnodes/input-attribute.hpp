...
class InputAttribute : public Composite {
public:
    static Result<WidgetPtr> create(
        ...
        auto widget = std::make_shared<InputAttribute>();
        ...
        if (auto res = widget->init(); !res) {
            return Err<WidgetPtr>("InputAttribute::create failed", res);
        }
        return widget;
    }
...
protected:
    Result<void> _begin_container() override {
        ...
        ImNodes::BeginInputAttribute(_attr_id);
