...
public:
    static Result<WidgetPtr> create(
        ...
        auto widget = std::make_shared<InputInt>();
        ...
        if (auto res = widget->init(); !res) {
            return Err<WidgetPtr>("InputInt::create failed", res);
        }
        return widget;
    }
...
extern "C" const char* name() { return "input-int"; }
...
extern "C" void* create(
    ...
    return static_cast<void*>(new ymery::Result<ymery::WidgetPtr>(ymery::plugins::InputInt::create(wf, d, ns, db)));
}
