// dockable-window widget plugin - a window that docks into a dock space
...
extern "C" const char* name() { return "dockable-window"; }
...
extern "C" void* create(
    ...
    return static_cast<void*>(new ymery::Result<ymery::WidgetPtr>(ymery::plugins::DockableWindow::create(wf, d, ns, db)));
}
