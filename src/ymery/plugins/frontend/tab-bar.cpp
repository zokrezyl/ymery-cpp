...
extern "C" const char* name() { return "tab-bar"; }
...
extern "C" void* create(
    ...
    return static_cast<void*>(new ymery::Result<ymery::WidgetPtr>(ymery::plugins::TabBar::create(wf, d, ns, db)));
}
