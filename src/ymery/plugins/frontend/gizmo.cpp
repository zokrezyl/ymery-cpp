// gizmo widget plugin - 3D gizmo manipulation
...
extern "C" const char* name() { return "gizmo"; }
...
extern "C" void* create(
    ...
    return static_cast<void*>(new ymery::Result<ymery::WidgetPtr>(ymery::plugins::Gizmo::create(wf, d, ns, db)));
}
