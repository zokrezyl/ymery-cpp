...
public:
    static Result<WidgetPtr> create(
        ...
        auto widget = std::make_shared<Text>();
        ...
        if (auto res = widget->init(); !res) {
            return Err<WidgetPtr>("Text::create failed", res);
        }
        return widget;
    }
...
extern "C" void* PLUGIN_EXPORT_CREATE(
    ...
    return static_cast<void*>(new ymery::Result<ymery::WidgetPtr>(ymery::plugins::Text::create(wf, d, ns, db)));
}
