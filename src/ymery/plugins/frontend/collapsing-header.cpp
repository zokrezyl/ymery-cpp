// collapsing-header widget plugin
...
class CollapsingHeader : public Composite {
public:
    static Result<WidgetPtr> create(
        ...
        auto widget = std::make_shared<CollapsingHeader>();
        ...
        if (auto res = widget->init(); !res) {
            return Err<WidgetPtr>("CollapsingHeader::create failed", res);
        }
        return widget;
    }
...
extern "C" const char* PLUGIN_EXPORT_NAME() { return "collapsing-header"; }
...
extern "C" void* PLUGIN_EXPORT_CREATE(
    ...
    return static_cast<void*>(new ymery::Result<ymery::WidgetPtr>(ymery::plugins::CollapsingHeader::create(wf, d, ns, db)));
}
